...
/**
 * Constants used within Assumption Analyzer.
 */
public class Constants {
    ...
    public static final String DEFAULT_SAVE_LOCATION =
            Constants.USER_HOME_PATH + Constants.FILE_SYSTEM_SEPARATOR + Constants.DEFAULT_SAVE_FILE_NAME;
    public static final String DEFAULT_STAGE_TITLE =
            Constants.APPLICATION_NAME + " — " + Constants.DEFAULT_SAVE_FILE_NAME;
    ...
    public static final String DOCUMENTATION_URL = "https://git.scc.kit.edu/i43/stud/praktika/sose2023" +
            "/timnorbertbaechle";
